...
{
    public class CompanyDealController : Controller
    {
        private readonly ApplicationDbContext _context;

        public CompanyDealController(ApplicationDbContext context)
        {
            _context = context;
        }
